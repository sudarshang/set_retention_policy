...
This is a sample template for set_retention_policy - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name set_retention_policy \
...
aws cloudformation describe-stacks \
    --stack-name set_retention_policy --query 'Stacks[].Outputs'
```
